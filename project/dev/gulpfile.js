...
gulp.task('1 ============== DEVELOPMENT', function(callback) {
	...
	imagemin = false;
	dev = true;
	runSequence('jsonData', 'devPage', 'robots', 'page', 'post', 'font', 'sassVendor', 'sassFoundation', 'sassComponent', 'sassProject', 'sassUtility', 'sassDev', 'styleGuide', 'js', 'img', 'watch', 'browserSync', callback);
});
// =================================================================================================
...
gulp.task('2 ============== DEVELOPMENT__CLEANUP', function(callback) {
	...
	imagemin = false;
	dev = true;
	runSequence('clean', 'jsonData', 'robots', 'page', 'post', 'font', 'sassVendor', 'sassFoundation', 'sassComponent', 'sassProject', 'sassUtility', 'sassDev', 'styleGuide', 'js', 'img', 'watch', 'browserSync', callback);
});
// =================================================================================================
// TEST
// =================================================================================================
